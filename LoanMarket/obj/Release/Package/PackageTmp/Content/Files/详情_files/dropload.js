    ...
    MyDropLoad.prototype.init = function(options){
        ...
        me.opts = $.extend(true, {}, {
            ...
            domUp : {                                                            // 上方DOM
                ...
                domUpdate  : '<div class="weui-loadmore"><span class="weui-loadmore__tips">↑释放更新</span></div>',
            ...
            domDown : {                                                          // 下方DOM
                ...
                domLoad    : '<div class="weui-loadmore"><i class="weui-loading"></i><span class="weui-loadmore__tips">正在加载</span></div>',
                domNoData  : '<div class="weui-loadmore weui-loadmore_line"><span class="weui-loadmore__tips">暂无数据</span></div>'
            },
            autoLoad : true,                                                     // 自动加载
            distance : 50,                                                       // 拉动距离
            threshold : '',                                                      // 提前加载距离
